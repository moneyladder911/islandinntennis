        ...
        >
          ...
          <div className="mb-8 p-5 border border-clay/30 bg-forest/5 rounded-sm">
            ...
            <p className="text-[13px] font-light leading-[1.6] text-forest/80">
              We're expanding our weekly schedule! Join us for <strong>Monday Mix Plays</strong>, <strong>Wednesday All Men's</strong>, and <strong>Sundays High Level Men's (3.5+)</strong> sessions. Additionally, we are thrilled to start playing competitive <strong>Inter-Club Matches</strong> across the island.
            </p>
          </div>
