        ...
        <div className="hidden md:block fixed bottom-10 right-10 z-[1001]">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-bold tracking-[2.5px] uppercase group-hover:text-white transition-colors">Text Kim to Play</span>
              <span className="text-[8px] font-medium opacity-70 group-hover:opacity-100 transition-opacity uppercase">Martha's Vineyard</span>
            </div>
          </a>
        </div>
      </div>
