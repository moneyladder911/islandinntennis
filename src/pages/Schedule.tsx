...
const SchedulePage: React.FC = () => {
  const offerings = [
    ...
    { icon: <Trophy size={24} className="text-gold" />, title: 'Sundays High Level Men\'s (3.5+)', desc: 'End your week with competitive, fast-paced matches. Open exclusively to male players with a 3.5+ rating.' },
